...
from .. import Debug, objects


CLASS_PROPERTIES = { }


class QObjectHelper(Debug):
    ...
    def refreshProperty(self, attr):
        ...
        if kwargs:
            ...
            if not attr in self._propCache or x != self._propCache[attr]:
                if self.refreshingAttr() != attr: # refreshProperty will be called again from _cachedPropSetter() immediately following this call.
